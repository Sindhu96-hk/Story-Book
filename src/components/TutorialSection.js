...
function TutorialSection({lightBg, topLine, lightText, lightTextDesc, headline, headline1, description, description1, img, alt, imgStart,}) {
                    ...
                    >
                        <div className="col heroSec">
                            <div className="home__hero-text-wrapper">
                                ...
                                <h1 className={lightText ? 'tutorial' : 'heading dark'}><img src="images/book.svg" className="tutorial-img"></img>{headline}</h1>
                        ...
                        <li className='nav-item2'>
                         ...
                         <div className="home__hero-text-wrapper">
                                ...
                                <h1 className={lightText ? 'tutorial' : 'heading dark'}><img src="images/direction.svg" className="tutorial-img"></img>{headline1}</h1>
                                <p className={lightTextDesc ? 'home__tutorial-subtitle' : 'home__tutorial-subtitle dark'}>
                                {description1}</p>
